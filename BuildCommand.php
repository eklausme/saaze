...
class BuildCommand {
	...
	public function buildAllStatic(string $dest, bool $tags, bool $rssXmlFeed, bool $sitemap) : void {
		$t0 = microtime(true);
		...
		if ($sitemap)
			file_put_contents($dest.'/sitemap.html', $this->templateManager->renderGeneral($collections,'sitemap'));
